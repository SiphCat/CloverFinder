-- Leaderboard: rank users by verified clover badge count (optional leaf filter).
-- Prefer running setup_leaderboard.sql (creates user_badges + function in one go).
-- Or run cloverfinder_finds_badges_media.sql for the full app.
